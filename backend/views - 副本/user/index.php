...
Html::cssFile('@web/css/plugins/footable/footable.core.css');
?>

    <nav class="breadcrumb fix_top hidden-sm hidden-xs" style="height: 45px;">
        <div class="pull-right">
            <a class="btn btn-primary radius " style="line-height:1.6em;margin-top:3px"
...
Html::jsFile('@web/js/plugins/footable/footable.all.min.js');
