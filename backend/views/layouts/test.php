        ...
        <div class="col-sm-4">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <p><i class="fa fa-qq"></i> QQ：<a href="http://wpa.qq.com/msgrd?v=3&uin=516477188&site=qq&menu=yes"
                                                      target="_blank">516477188</a>
                    </p>
                    <p><i class="fa fa-weixin"></i> 微信：<a href="javascript:;">zheng-zihan</a>
                    </p>
                    <p><i class="fa fa-credit-card"></i> 支付宝：<a href="javascript:;" class="支付宝信息">zheng-zihan@qq.com /
                            *子涵</a>
                    </p>
                </div>
            </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h5 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#version" href="#v41">v4.1.0</a><code
                                    ...
                                    <div class="panel-body">
                                        <ol>
                                            ...
                                            <li>增加<a href="toastr_notifications.html">Toastr通知</a>、<a
                                                    href="nestable_list.html">嵌套列表</a>、<a href="timeline_v2.html">时间轴</a>、<a
                                                    href="forum_main.html">论坛</a>、<a
                                                    href="code_editor.html">代码编辑器</a>、<a href="modal_window.html">模态窗口</a>、<a
        ...
        <div class="col-sm-4">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <hr>
                    <p>如果需要购买H+主题，可直接付款到支付宝：<a href="javascript;">zheng-zihan@qq.com</a>，收款人：<a
                            href="javascript;">*子涵</a>。也可以使用手机支付宝或者微信扫码支付：</p>
                ...
                <div class="tab-content" style="line-height:1.8em;">
                    <div id="layouts" class="tab-pane active">
                        <div class="panel-body">
                            ...
                            <hr>
                            <span class="label label-danger">特别致谢</span> 感谢[子·梦]同学提供的contentTabs优化方案和代码！</p>
                        </div>
                    </div>
