    ...
    public static function getMenuCopy($isFind = false)
    {
        ...
        if ("" == $menu || null == $menu || $isFind == true) {
            ...
            foreach ($menuData as $key => $value) {
                ...
                $TempMenu = ['label' => '<i class="fa fa-cog"></i><span class="nav-label">' . $value['description'] . '</span>' . $faarrow, 'url' => false];
                if (!empty($value->children)) {
                    $tempChild = [];
                    foreach ($value->children as $ke => $val) {
                    ...
                    $TempMenu['url'] = Url::toRoute($value['name']);
                }
                $TempMenu['active'] = in_array($route, $activeUrl);
                $menu[]             = $TempMenu;
            }
            Yii::$app->cache->delete('menu');
            array_unshift($menu, self::getMenuHead());
            ...
            'label'   => '
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear"><span class="block m-t-xs"><strong class="font-bold">Beaut-zihan</strong></span>
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            ...
                            <li class="divider"></li>
                            <li><a href="<?= \yii\helpers\Url::toRoute(\'/site/logout\'); ?>">安全退出</a> </li>
                        </ul>
                    </div>
